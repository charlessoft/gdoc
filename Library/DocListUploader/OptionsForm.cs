...
namespace DocListUploader
{
    public partial class OptionsForm : Form
    {
        ...
        private void test(DocumentsService service)
        {
            ...
            entry.Title.Text = "Legal Contract.pdf";

            // Set the media source
            entry.MediaSource = new MediaFileSource("c:\\a1.pdf", "application/pdf");

            // Define the resumable upload link
            //Uri createUploadUrl = new Uri("https://docs.google.com/feeds/upload/create-session/default/private/full");
            Uri createUploadUrl = new Uri("https://docs.google.com/feeds/upload/create-session/default/private/full/folder%3A0Bx2t-pXbg_dqalZQREUxTExNQlk/contents");
            ...
            ClientLoginAuthenticator clientlogin = new ClientLoginAuthenticator("application", "writely", service.Credentials);
//            uploader.InsertAsync(clientlogin, entry, new object());
            uploader.Insert(clientlogin, entry);
        }
        private void OptionsForm_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string file in fileList)
            {
                try
                {
                   ...
                   DocumentsService service =  mainForm.GetServices();
                    test(service);
                    //UpdateDocList();
                }
